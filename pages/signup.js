  ...
  return (
    <div className='h-screen flex justify-center items-center' >
      <div className='flex flex-col w-96' >
        ...
        <p className='text-center mb-4 text-md' >Already have an account? <span onClick={navHandler} className='text-yellow-500 font-semibold cursor-pointer' >Sign in!</span></p>
...
const Button = (props) => {
  ...
  return (
    <button onClick={btnHandler} className='w-96 h-12 rounded text-white bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:ring-yellow-400 focus:ring-opacity-50 focus:outline-none transition ease-in duration-100'>
      Register
    </button>
  )
}
